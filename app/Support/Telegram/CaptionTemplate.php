...
final class CaptionTemplate
{
    ...
    public static function render(string $body, array $ctx): string
    {
        ...
        // Хвостовые пробелы в конце строк. Пустой плейсхолдер в середине
        // строки оставляет после себя пробел: «<b>Спектакль …</b> » — значок
        // темы молчит, когда тема уже названа словом, и пробел остаётся
        // висеть. Чистим ЗДЕСЬ, а не в шаблоне: так защищены все шаблоны и
        // все ключи, а не тот один, на котором это заметили.
