 ...
 *
 * Поверх WebVenueResource: street/house/fias, описание, контакты, ритм места
 * и прошлое. Списка событий здесь нет — почему, сказано у future_events ниже.
 *
...
class WebVenueDetailResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            // Зачем различать источник картинки — см. WebVenueResource.
     ...
     * разобрано в VenuesController::loadSources(). Ни «официальный», ни
     * «проверено» тут тоже не появится: мы знаем связь, а не статус.
     *
