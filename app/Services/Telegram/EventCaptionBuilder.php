...
final class EventCaptionBuilder
{
     ...
     */
    /**
     * Значок темы для поста события.
     *
     * Карта и лестница переехали в [[KindEmoji]] — их же берёт строка
     * подборки. ПОДАВЛЕНИЕ здесь включено и должно остаться: значок стоит
     * вплотную к названию, и повтор первого слова тратит единственный слот,
     * где мог бы стоять знак со смыслом.
     *
     * @param  array<string, mixed>  $raw
     */
