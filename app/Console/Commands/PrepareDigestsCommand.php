 ...
 *
 * ЗАЧЕМ. Состав и текст появлялись внутри доставки, за секунды до выхода поста
 * (замер и выбор горизонта — `config/broadcast_digest.prepare_hours`).
 * Посмотреть на состав, а тем более поменять в нём позицию, было некогда.
 *
